...
-- 		_G.open_projects_learnings = function()
-- 			local roots = {
...
-- 			dashboard.button("p", "♚ Lab", ":lua _G.open_projects_learnings()<CR>"),
-- 			dashboard.button("f", "☢ Latest Folders", ":lua _G.recent_folders()<CR>"),
-- 			dashboard.button("n", " New File", ":ene!<CR>"),
-- 			dashboard.button("r", " Recent files", ":Telescope oldfiles<CR>"),
-- 			dashboard.button("t", " Find Text", ":Telescope live_grep<CR>"),
-- 			dashboard.button("c", " Config", ":lua _G.open_config()<CR>)"),
